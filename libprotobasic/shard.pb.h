...
class SubCrossShardTx :
 ...
 public:
  ...
  const std::string& stateaddress() const;
  void set_stateaddress(const std::string& value);
  void set_stateaddress(std::string&& value);
  void set_stateaddress(const char* value);
  void set_stateaddress(const void* value, size_t size);
  std::string* mutable_stateaddress();
  std::string* release_stateaddress();
  void set_allocated_stateaddress(std::string* stateaddress);
  private:
  const std::string& _internal_stateaddress() const;
  void _internal_set_stateaddress(const std::string& value);
  std::string* _internal_mutable_stateaddress();
  public:
  ...
  // bytes txIds = 10;
  void clear_txids();
  const std::string& txids() const;
  void set_txids(const std::string& value);
  void set_txids(std::string&& value);
  void set_txids(const char* value);
  void set_txids(const void* value, size_t size);
  std::string* mutable_txids();
  std::string* release_txids();
  void set_allocated_txids(std::string* txids);
  private:
  const std::string& _internal_txids() const;
  void _internal_set_txids(const std::string& value);
  std::string* _internal_mutable_txids();
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_txnum() const;
  void _internal_set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr txids_;
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 txnum_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_shard_2eproto;
};
// -------------------------------------------------------------------
...
// bytes stateAddress = 1;
inline void SubCrossShardTx::clear_stateaddress() {
  stateaddress_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SubCrossShardTx::stateaddress() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTx.stateAddress)
  return _internal_stateaddress();
}
inline void SubCrossShardTx::set_stateaddress(const std::string& value) {
  _internal_set_stateaddress(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTx.stateAddress)
}
inline std::string* SubCrossShardTx::mutable_stateaddress() {
  // @@protoc_insertion_point(field_mutable:protos.SubCrossShardTx.stateAddress)
  return _internal_mutable_stateaddress();
}
inline const std::string& SubCrossShardTx::_internal_stateaddress() const {
  return stateaddress_.GetNoArena();
}
inline void SubCrossShardTx::_internal_set_stateaddress(const std::string& value) {
  
  stateaddress_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SubCrossShardTx::set_stateaddress(std::string&& value) {
  
  stateaddress_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protos.SubCrossShardTx.stateAddress)
}
inline void SubCrossShardTx::set_stateaddress(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  stateaddress_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protos.SubCrossShardTx.stateAddress)
}
inline void SubCrossShardTx::set_stateaddress(const void* value, size_t size) {
  
  stateaddress_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protos.SubCrossShardTx.stateAddress)
}
inline std::string* SubCrossShardTx::_internal_mutable_stateaddress() {
  
  return stateaddress_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SubCrossShardTx::release_stateaddress() {
  // @@protoc_insertion_point(field_release:protos.SubCrossShardTx.stateAddress)
  
  return stateaddress_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SubCrossShardTx::set_allocated_stateaddress(std::string* stateaddress) {
  if (stateaddress != nullptr) {
    
  } else {
    
  }
  stateaddress_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), stateaddress);
  // @@protoc_insertion_point(field_set_allocated:protos.SubCrossShardTx.stateAddress)
}
...
// uint64 txNum = 9;
inline void SubCrossShardTx::clear_txnum() {
  txnum_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTx::_internal_txnum() const {
  return txnum_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTx::txnum() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTx.txNum)
  return _internal_txnum();
}
inline void SubCrossShardTx::_internal_set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  txnum_ = value;
}
inline void SubCrossShardTx::set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_txnum(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTx.txNum)
}

// bytes txIds = 10;
inline void SubCrossShardTx::clear_txids() {
  txids_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SubCrossShardTx::txids() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTx.txIds)
  return _internal_txids();
}
inline void SubCrossShardTx::set_txids(const std::string& value) {
  _internal_set_txids(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTx.txIds)
}
inline std::string* SubCrossShardTx::mutable_txids() {
  // @@protoc_insertion_point(field_mutable:protos.SubCrossShardTx.txIds)
  return _internal_mutable_txids();
}
inline const std::string& SubCrossShardTx::_internal_txids() const {
  return txids_.GetNoArena();
}
inline void SubCrossShardTx::_internal_set_txids(const std::string& value) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SubCrossShardTx::set_txids(std::string&& value) {
  
  txids_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protos.SubCrossShardTx.txIds)
}
inline void SubCrossShardTx::set_txids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protos.SubCrossShardTx.txIds)
}
inline void SubCrossShardTx::set_txids(const void* value, size_t size) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protos.SubCrossShardTx.txIds)
}
inline std::string* SubCrossShardTx::_internal_mutable_txids() {
  
  return txids_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SubCrossShardTx::release_txids() {
  // @@protoc_insertion_point(field_release:protos.SubCrossShardTx.txIds)
  
  return txids_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SubCrossShardTx::set_allocated_txids(std::string* txids) {
  if (txids != nullptr) {
    
  } else {
    
  }
  txids_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), txids);
  // @@protoc_insertion_point(field_set_allocated:protos.SubCrossShardTx.txIds)
}
...
// bytes shardIds = 6;
inline void SubCrossShardTxReply::clear_shardids() {
  shardids_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SubCrossShardTxReply::shardids() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxReply.shardIds)
  return _internal_shardids();
}
inline void SubCrossShardTxReply::set_shardids(const std::string& value) {
  _internal_set_shardids(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxReply.shardIds)
}
inline std::string* SubCrossShardTxReply::mutable_shardids() {
  // @@protoc_insertion_point(field_mutable:protos.SubCrossShardTxReply.shardIds)
  return _internal_mutable_shardids();
}
inline const std::string& SubCrossShardTxReply::_internal_shardids() const {
  return shardids_.GetNoArena();
}
inline void SubCrossShardTxReply::_internal_set_shardids(const std::string& value) {
  
  shardids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SubCrossShardTxReply::set_shardids(std::string&& value) {
  
  shardids_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protos.SubCrossShardTxReply.shardIds)
}
inline void SubCrossShardTxReply::set_shardids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  shardids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protos.SubCrossShardTxReply.shardIds)
}
inline void SubCrossShardTxReply::set_shardids(const void* value, size_t size) {
  
  shardids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protos.SubCrossShardTxReply.shardIds)
}
inline std::string* SubCrossShardTxReply::_internal_mutable_shardids() {
  
  return shardids_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SubCrossShardTxReply::release_shardids() {
  // @@protoc_insertion_point(field_release:protos.SubCrossShardTxReply.shardIds)
  
  return shardids_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SubCrossShardTxReply::set_allocated_shardids(std::string* shardids) {
  if (shardids != nullptr) {
  ...
  shardids_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), shardids);
  // @@protoc_insertion_point(field_set_allocated:protos.SubCrossShardTxReply.shardIds)
}
...
// uint64 txNum = 8;
inline void SubCrossShardTxReply::clear_txnum() {
  txnum_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTxReply::_internal_txnum() const {
  return txnum_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTxReply::txnum() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxReply.txNum)
  return _internal_txnum();
}
inline void SubCrossShardTxReply::_internal_set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  txnum_ = value;
}
inline void SubCrossShardTxReply::set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_txnum(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxReply.txNum)
}

// bytes txIds = 9;
inline void SubCrossShardTxReply::clear_txids() {
  txids_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SubCrossShardTxReply::txids() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxReply.txIds)
  return _internal_txids();
}
inline void SubCrossShardTxReply::set_txids(const std::string& value) {
  _internal_set_txids(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxReply.txIds)
}
inline std::string* SubCrossShardTxReply::mutable_txids() {
  // @@protoc_insertion_point(field_mutable:protos.SubCrossShardTxReply.txIds)
  return _internal_mutable_txids();
}
inline const std::string& SubCrossShardTxReply::_internal_txids() const {
  return txids_.GetNoArena();
}
inline void SubCrossShardTxReply::_internal_set_txids(const std::string& value) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SubCrossShardTxReply::set_txids(std::string&& value) {
  
  txids_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protos.SubCrossShardTxReply.txIds)
}
inline void SubCrossShardTxReply::set_txids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protos.SubCrossShardTxReply.txIds)
}
inline void SubCrossShardTxReply::set_txids(const void* value, size_t size) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protos.SubCrossShardTxReply.txIds)
}
inline std::string* SubCrossShardTxReply::_internal_mutable_txids() {
  
  return txids_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SubCrossShardTxReply::release_txids() {
  // @@protoc_insertion_point(field_release:protos.SubCrossShardTxReply.txIds)
  
  return txids_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SubCrossShardTxReply::set_allocated_txids(std::string* txids) {
  if (txids != nullptr) {
  ...
  txids_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), txids);
  // @@protoc_insertion_point(field_set_allocated:protos.SubCrossShardTxReply.txIds)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTxCommit::_internal_txnum() const {
  return txnum_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTxCommit::txnum() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxCommit.txNum)
  return _internal_txnum();
}
inline void SubCrossShardTxCommit::_internal_set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  txnum_ = value;
}
inline void SubCrossShardTxCommit::set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_txnum(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxCommit.txNum)
}

// bytes txIds = 9;
inline void SubCrossShardTxCommit::clear_txids() {
  txids_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SubCrossShardTxCommit::txids() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxCommit.txIds)
  return _internal_txids();
}
inline void SubCrossShardTxCommit::set_txids(const std::string& value) {
  _internal_set_txids(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxCommit.txIds)
}
inline std::string* SubCrossShardTxCommit::mutable_txids() {
  // @@protoc_insertion_point(field_mutable:protos.SubCrossShardTxCommit.txIds)
  return _internal_mutable_txids();
}
inline const std::string& SubCrossShardTxCommit::_internal_txids() const {
  return txids_.GetNoArena();
}
inline void SubCrossShardTxCommit::_internal_set_txids(const std::string& value) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SubCrossShardTxCommit::set_txids(std::string&& value) {
  
  txids_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protos.SubCrossShardTxCommit.txIds)
}
inline void SubCrossShardTxCommit::set_txids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protos.SubCrossShardTxCommit.txIds)
}
inline void SubCrossShardTxCommit::set_txids(const void* value, size_t size) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protos.SubCrossShardTxCommit.txIds)
}
inline std::string* SubCrossShardTxCommit::_internal_mutable_txids() {
  
  return txids_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SubCrossShardTxCommit::release_txids() {
  // @@protoc_insertion_point(field_release:protos.SubCrossShardTxCommit.txIds)
  
  return txids_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SubCrossShardTxCommit::set_allocated_txids(std::string* txids) {
  if (txids != nullptr) {
  ...
  txids_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), txids);
  // @@protoc_insertion_point(field_set_allocated:protos.SubCrossShardTxCommit.txIds)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTxCommitReply::_internal_txnum() const {
  return txnum_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SubCrossShardTxCommitReply::txnum() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxCommitReply.txNum)
  return _internal_txnum();
}
inline void SubCrossShardTxCommitReply::_internal_set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  txnum_ = value;
}
inline void SubCrossShardTxCommitReply::set_txnum(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_txnum(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxCommitReply.txNum)
}

// bytes txIds = 9;
inline void SubCrossShardTxCommitReply::clear_txids() {
  txids_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& SubCrossShardTxCommitReply::txids() const {
  // @@protoc_insertion_point(field_get:protos.SubCrossShardTxCommitReply.txIds)
  return _internal_txids();
}
inline void SubCrossShardTxCommitReply::set_txids(const std::string& value) {
  _internal_set_txids(value);
  // @@protoc_insertion_point(field_set:protos.SubCrossShardTxCommitReply.txIds)
}
inline std::string* SubCrossShardTxCommitReply::mutable_txids() {
  // @@protoc_insertion_point(field_mutable:protos.SubCrossShardTxCommitReply.txIds)
  return _internal_mutable_txids();
}
inline const std::string& SubCrossShardTxCommitReply::_internal_txids() const {
  return txids_.GetNoArena();
}
inline void SubCrossShardTxCommitReply::_internal_set_txids(const std::string& value) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void SubCrossShardTxCommitReply::set_txids(std::string&& value) {
  
  txids_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protos.SubCrossShardTxCommitReply.txIds)
}
inline void SubCrossShardTxCommitReply::set_txids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protos.SubCrossShardTxCommitReply.txIds)
}
inline void SubCrossShardTxCommitReply::set_txids(const void* value, size_t size) {
  
  txids_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protos.SubCrossShardTxCommitReply.txIds)
}
inline std::string* SubCrossShardTxCommitReply::_internal_mutable_txids() {
  
  return txids_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SubCrossShardTxCommitReply::release_txids() {
  // @@protoc_insertion_point(field_release:protos.SubCrossShardTxCommitReply.txIds)
  
  return txids_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SubCrossShardTxCommitReply::set_allocated_txids(std::string* txids) {
  if (txids != nullptr) {
  ...
  txids_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), txids);
  // @@protoc_insertion_point(field_set_allocated:protos.SubCrossShardTxCommitReply.txIds)
}
